...
- Для сложных публичных методов генерируй блок с простым примером использования кода внутри тега `<example>`
...
- Всегда старайся минимизировать размер кода без ущерба читаемости, если не запрошено иное
